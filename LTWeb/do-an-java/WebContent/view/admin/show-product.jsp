                    ...
                    <tbody>
                     <c:forEach items="${productlist}" var="product">
                      <tr>
                        ...
                        <td>${product.name }</td>
                        <td><img style="    width: 110px;height: 67px; object-fit: cover;border: 1px solid #fff;" src="${pageContext.request.contextPath}/view/upload/${product.image_link}" alt="${product.name}"></td>
