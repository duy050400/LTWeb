                ...
                <div class="table-responsive">
                  ...
                  <c:forEach items="${adminList}" var="user">
                      <tr>
        				...
        				<td>${user.created }</td>
        				 <td>
                          <button class="btn btn-danger"><a href="${pageContext.request.contextPath}/admin/admin/delete?user-id=${user.id}">Xóa</a></button>
                         
                          <button class="btn btn-success"><a href="${pageContext.request.contextPath}/admin/admin/edit?user-id=${user.id}">Sửa</a></button>
                        </td>
                     </tr>
                    </c:forEach>
                    </tbody>
